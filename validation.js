document.getElementById('buffer2-repetition-switch').addEventListener('change', function() {
    var label = document.getElementById('buffer2-repetition-switch-text');
    if (this.checked) {
  ...
  document.getElementById('buffer1-repetition-switch').addEventListener('change', function() {
    var label = document.getElementById('buffer1-repetition-switch-text');
    if (this.checked) {
      label.textContent = 'ON';
    } else {
      label.textContent = 'OFF';
...
document.getElementById('buffer1-check').addEventListener('change', function() {
    ...
    if (this.checked) {
        ...
        document.getElementById('buffer1-main-execute').disabled = false;
        document.getElementById('buffer1-repetition').disabled = false;

    } else {
        // Disable Buffer 1 inputs
        document.getElementById('buffer1-main-execute').disabled = true;
        ...
        buffer1PacketsInput.value = 0 // Clear input value
